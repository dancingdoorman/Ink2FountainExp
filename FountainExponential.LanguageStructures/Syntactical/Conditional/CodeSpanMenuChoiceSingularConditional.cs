...
{
    public class CodeSpanMenuChoiceSingularConditional : MenuChoiceSingularConditional, ISyntacticalElementable, IConditionable, ISingularConditionable, IConditionEvaluatable, ICodeSpanEnclosable
    {
