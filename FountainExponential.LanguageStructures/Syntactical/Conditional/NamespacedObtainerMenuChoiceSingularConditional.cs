...
{
    public class NamespacedObtainerMenuChoiceSingularConditional : MenuChoiceSingularConditional, ISyntacticalElementable, IConditionable, ISingularConditionable, IConditionEvaluatable
    {
